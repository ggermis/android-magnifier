...
public class CameraCapabilities {
    ...
    public static boolean isNegativeEffectSupported(final Camera.Parameters params) {
        return params.getSupportedColorEffects() != null && params.getSupportedColorEffects().contains(Camera.Parameters.EFFECT_NEGATIVE);
    }

    public static boolean isFocusSupported(final Camera.Parameters params) {
        return params.getSupportedFocusModes() != null && params.getSupportedFocusModes().containsAll(Arrays.asList(Camera.Parameters.FOCUS_MODE_AUTO, Camera.Parameters.FOCUS_MODE_MACRO));
    }
